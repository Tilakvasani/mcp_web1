...
async def run_agent(
    ...
    if all_tools:
        ...
        if agent == "hubspot":
            ...
            # Cross agent: search hubspot index (which also stores zoho
            # tools if both are indexed under their own keys).
            # We search hubspot first; the hybrid_search handles
            # agent_filter=None for cross-system queries.
            rag_key = "hubspot"
